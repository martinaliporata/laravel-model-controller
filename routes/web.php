...
Route::get('/', function () {
    ...
    return view('pages.home', compact('navbar', 'books', 'navbarDcComics', 'navbarShop', 'navbarDc', 'navbarSites'));
}) ->name('guest.home');
...
Route::get('/products', function () {
    ...
    return view('pages.products', compact('navbar', 'books', 'navbarDcComics', 'navbarShop', 'navbarDc', 'navbarSites'));
}) ->name('guest.products');
